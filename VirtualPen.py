...
# Callback method that goes into the trackbar function
def nothing(x):
    pass
...
# now create 6 trackbars that will control the lower and upper range of HSV channels.
# For Hue the range is 0-179 and for SV its 0-255
...
while True:
    ...
    # Get the new value of trackbar in real time as the user changes them
    ...
    # On pressing s, pring the array
    if key == ord('s'):
        thearray = [[l_h, l_s, l_v], [u_h, u_s, u_v]]
        print(thearray)

        # Save the array as penval.npy
